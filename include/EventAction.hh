...
public:
  ...
  std::vector<G4double> &GetLaminaPosX() { return fLaminaPosX; }
  std::vector<G4double> &GetLaminaPosY() { return fLaminaPosY; }
  std::vector<G4double> &GetLaminaPosZ() { return fLaminaPosZ; }
...
private:
  ...
  std::vector<G4double> fLaminaPosX;
  std::vector<G4double> fLaminaPosY;
  std::vector<G4double> fLaminaPosZ;
