...
for file_num, file_name in enumerate(os.listdir(data_directory)):
    ...
    with uproot.open(file_path) as f:
        ...
        curvar_ind = int(
            (curvar - parameter_array[0]) / (parameter_array[1] - parameter_array[0])
        )
        ...
        for label in intermediate_dict:
            ...
            proc_plot_dict[label][curvar_ind] = (
                intermediate_dict[label] / num_histories_per_run
            )
