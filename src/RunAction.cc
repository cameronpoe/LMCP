...
// Constructor
//****************************************************************************
RunAction::RunAction(EventAction *eventAct) : fEventAction(eventAct) {
  ...
  analysisManager->CreateNtupleDColumn("PosX", fEventAction->GetLaminaPosX());
  analysisManager->CreateNtupleDColumn("PosY", fEventAction->GetLaminaPosY());
  analysisManager->CreateNtupleDColumn("PosZ", fEventAction->GetLaminaPosZ());
  ...
  analysisManager->CreateNtupleSColumn("CreatorProc",
                                       fEventAction->GetPoreCreatorProc());
